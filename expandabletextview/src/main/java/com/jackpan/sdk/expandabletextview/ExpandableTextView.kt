package com.jackpan.sdk.expandabletextview
...
class ExpandableTextView @JvmOverloads constructor(
    ...
    private fun setupAttributes(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        readMoreMaxLine =
            typedArray.getInt(R.styleable.ExpandableTextView_readMoreMaxLine, readMoreMaxLine)
        readMoreText =
            typedArray.getString(R.styleable.ExpandableTextView_readMoreText) ?: readMoreText
        readMoreColor =
            typedArray.getColor(R.styleable.ExpandableTextView_readMoreColor, readMoreColor)
        typedArray.recycle()
    }
    ...
    override fun setOnClickListener(onClickListener: OnClickListener?) {
        throw UnsupportedOperationException("You can not use OnClickListener in ExpandableTextView")
    }
